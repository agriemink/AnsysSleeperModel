...
LoadType(1) = 'Displacement' ! 'Displacement' [meters] or 'Force' [Newtons]
!Some suggestions:

! Negative loads for wheel load == acting downwards
! Positve loads for symmetric lateral loads. Positvie == acting inwards

!Comment the non-used double labels to prevent a warning message from popping up.
Loadtable_Q_sym(1,1) = 		0, 	0,
LoadTable_Y_left(1,1) =		0, 	2/1000 !2 mm 
!Basic zeros
