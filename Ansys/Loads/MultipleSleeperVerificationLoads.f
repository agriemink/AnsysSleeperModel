...
!----------------------------------------------------------------------
TimeArray(1,1) 	= 1, 2, 3! Time this should be as long as Array_size -------
...
!Q = 110000 !Based on maximum axle load


!Comment the non-used labels to prevent a warning message from popping up.
! 202 analysis showed that at 110 kN the centre sleeper load was 174 kN (both wheels) so this becomes 
!
!
Loadtable_Q_sym(1,1) = 		0, 	-110000, -209000
LoadTable_Y_left(1,1) =		0, 	0, 		0
!Basic zeros
Loadtable_Y_sym(1,1) = 		0, 	0, 		0
LoadTable_Q_right(1,1) = 	0, 	0, 		0
LoadTable_Y_right(1,1) = 	0, 	0, 		0
