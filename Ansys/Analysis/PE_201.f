...
analysisFilename(1) = 'PE_201' !Optional name. This gets saved as parameter so it is possible to track the results back to this file.

!Use materials as set in the materials folder [DefineMaterialnumber.f]
Materiaal_S = Kunststof_330
Materiaal_W = Staal
Materiaal_RH = Staal
...
Sleepers(1,1) = 1, 201, W_Divisions, K_foundation, fundering_OndersteundPercentage, fundering_MultiplierOndersteund !Use K_foundation as it is an provided default.Other values set in index-file. 
