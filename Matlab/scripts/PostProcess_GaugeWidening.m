function [] = PostProcess_GaugeWidening(analysisFolder, analysis_fileNames, output_directory, figureName, LoadCases, X_coord, Y_coord)
...
for index = 1:length(LoadCases)
    ...
    for analysis_nr = 1:length(analysis_fileNames)
        ...
        filename = GetAnalysisdata(analysisFolder, analysis_fileNames{analysis_nr}, loadCase, 'GaugeNodes');
