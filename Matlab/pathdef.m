...
p = [...
%%% BEGIN ENTRIES %%%
     'O:\AnsysSleeperModel\Matlab\scripts;', ...
     'scripts;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\logos;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\src;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\src\dev;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\examples;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\output;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\suites;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\template;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\template\data;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\template\data\converted;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\matlab2tikz\test\template\data\reference;', ...
     'O:\AnsysSleeperModel\Matlab\scripts\sortStruct;', ...
